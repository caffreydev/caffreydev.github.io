export const Home = () => {
    ...
    <h2>This site serves as a portfolio page, and reference to my other projects</h2>
        ...
        <p>
            This site serves as a simple profile, to link to some of my projects and other works, as well as my social feeds in one place.
            intend in the very near future to also add a blog and newsletter where I will be commenting on developments in the technology space.
        </p>
